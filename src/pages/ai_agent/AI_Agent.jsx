  ...
  const handleQuickLink = (linkText) => {
    ...
    setTimeout(() => {
      ...
      if (linkText === "CREATE CAMPAIGN") {
        addMessage(
          "Great! Let's create a campaign. What type of campaign are you looking to set up?",
          "ai"
        );
      } else if (linkText === "VIEW INSIGHTS") {
        addMessage(
          "Here's a summary of your recent campaign performance. Would you like to see more detailed analytics?",
          "ai"
        );
      } else if (linkText === "FOLLOW UP") {
        addMessage(
          "I can help you create follow-up messages for your campaign. Would you like me to suggest some templates?",
          "ai"
        );
      } else if (linkText === "VIEW REFERRALS") {
        addMessage(
          "Here's a summary of your referral program performance. You've received 12 referrals this month.",
          "ai"
        );
      }
    }, 1500);
  ...
  const campaignSummary = (
    <div className=" rounded-lg p-4 my-2 w-full">
      <ul className="list-disc pl-6 space-y-1 bg-purple-50 p-3 text-sm">
        <li>
          <span className="font-semibold">Goal:</span> Increase sales
        </li>
        <li>
          <span className="font-semibold">Reward:</span> 15% discount on the
          next purchase
        </li>
        <li>
          <span className="font-semibold">Condition:</span> Reward is given when
          the referred person makes a purchase
        </li>
        <li>
              ...
              >
                ...
                >
                  {message.content.includes(
                    "Here's a summary of your recent campaign performance"
                  ) ? (
                    <>
                ...
                {message.sender === "user" && (
                  <div className=" rounded-full ml-2 h-8 w-8 flex-shrink-0 flex items-center justify-center">
                    <img
